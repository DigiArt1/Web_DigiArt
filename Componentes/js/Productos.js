...
function setActiveNavLink() {
    ...
    // Buscar el enlace de "Productos" y marcarlo como activo
    navLinks.forEach(link => {
...
function initProductosCards() {
    ...
    productoCards.forEach(card => {
        ...
        const botones = card.querySelectorAll('.btn-producto');
        botones.forEach(boton => {
            ...
            boton.addEventListener('click', function (e) {
                ...
                const productoNombre = this.closest('.producto-card').querySelector('h3').textContent;
                const accion = this.textContent.includes('Demo') || this.textContent.includes('Probar') ? 'demo' : 'compra';
                mostrarNotificacion(productoNombre, accion);
            });
        });
    ...
    style.textContent = `
        ...
        .producto-card:hover .caracteristica {
            animation: slideInLeft 0.3s ease forwards;
        }
        
        .producto-card:hover .caracteristica:nth-child(1) { animation-delay: 0.1s; }
        .producto-card:hover .caracteristica:nth-child(2) { animation-delay: 0.2s; }
        .producto-card:hover .caracteristica:nth-child(3) { animation-delay: 0.3s; }
        .producto-card:hover .caracteristica:nth-child(4) { animation-delay: 0.4s; }
...
// Mostrar notificación
function mostrarNotificacion(productoNombre, accion) {
    const mensaje = accion === 'demo' 
        ? `Redirigiendo a WhatsApp para solicitar demo de ${productoNombre}...`
        : `Redirigiendo a WhatsApp para comprar ${productoNombre}...`;
